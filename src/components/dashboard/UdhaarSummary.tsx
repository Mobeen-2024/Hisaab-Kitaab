    ...
    <div className="grid grid-cols-2 gap-6 relative z-10">
      ...
      >
        ...
        <div>
          ...
          <p className="text-xl font-black text-emerald-400 tabular-nums">{formatCompactCurrency(toReceive)}</p>
        </div>
      </button>
      <button
        onClick={() => navigate('/customers')}
      ...
      >
        ...
        <div>
          ...
          <p className="text-xl font-black text-rose-400 tabular-nums">{formatCompactCurrency(toPay)}</p>
        </div>
      </button>
    </div>
  );
